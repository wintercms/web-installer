 ...
 * Class EnvFile
 *
 * This is copied from https://github.com/wintercms/storm/blob/develop/src/Parse/EnvFile.php, but
 * modified to remove the requirement of Winter Storm, which includes too many dependencies and
 * isn't required for a simple installer.
 *
 * @author Jack Wilkinson <me@jaxwilko.com>
